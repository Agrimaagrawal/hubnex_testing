...
<div className=' w-full h-screen bg-vector relative bg-cover bg-no-repeat bg-center ' >
  {/* <div className=' md:hidden w-full'>
    ...
    <div className=' w-full md:w-[70%] h-full flex-none  md:flex m-auto justify-between items-center py-5 md:py-0'>
        <div className=' flex flex-col md:gap-5 justify-around md:justify-center gap-5 h-full font-semibold w-full'>
            <h2 className=' md:static top-8 left-14 md:mt-0 text-3xl md:text-6xl font-bold font-gilroy text-center md:text-start'>let us build it for you.</h2>
