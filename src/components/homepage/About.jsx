    ...
    <>
        <div className=" h-screen relative bg-rose-500 flex w-full md:max-[1000px]:flex-col-reverse justify-center items-center md:overflow-hidden ">
            ...
            <div className='flex flex-col h-full  md:translate-x-0 w-[80%] md:w-3/5 gap-5 md:gap-0 justify-center items-center md:overflow-hidden md:max-[1000px]:w-[50%] '>
                <div className='md:text-left text-white md:max-w-[400px] w-full  md:max-[1000px]:text-center'>
                    <span className=' text-3xl md:text-[60px] font-bold leading-tight font-gilroy-bold'>we are believers,</span>
                    <h2 className=' text-3xl md:text-[40px] font-bold'>of the human <span className='font-thin italic'>touch</span>.</h2>
                </div>
                <div className=" md:hidden">
