...
const MobileNavbar = () => {
  ...
  return (
    <div className=' absolute top-0 right-0 overflow-hidden  h-screen w-full z-40 md:hidden inline'>
        ...
        <div className={`md:hidden ${!open ? 'translate-x-full' : 'translate-x-0 fixed'} h-full w-full gap-10 transition-all duration-500 ease-in text-white font-semibold bg-gradient-to-br z-50 from-gray-600 to-gray-800 flex flex-col items-center justify-center`}>
