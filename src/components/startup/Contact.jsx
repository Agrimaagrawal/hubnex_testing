       ...
       <div className=' w-[80%] flex flex-col h-full m-auto justify-between items-center'>
          <div className=' flex w-full justify-between h-full items-center'>
            ...
            <div className=' flex flex-col gap-5 w-[50%] items-center'>
                <span className=' text-4xl font-bold'>Connect with us</span>
                <p className=' text-2xl text-center'>Revolutionize Your Startup's IT Strategy with Our Consultancy Services</p>
            </div>

            <div className=' bg-violet-400 bg-opacity-5 h-[80%] flex flex-col  items-center justify-center gap-10 w-[40%]'>
              <span className=' text-4xl font-bold'>Let's build it together</span>
