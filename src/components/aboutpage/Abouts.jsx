        ...
        <div className=' h-full w-full flex items-center justify-center'> 
          <div className=' flex items-center h-full w-[80%]'>
            <div className=' flex flex-col text-black gap-10 w-[650px] '>
              <span className=' text-5xl font-bold'>Digital guidance <br/>expertise</span>
              ...
              <button className=' bg-transparent w-max rounded-full py-2 px-5 border-black border-[2px]'>Read more</button>
            </div>
          </div>
        </div>
    </div>
