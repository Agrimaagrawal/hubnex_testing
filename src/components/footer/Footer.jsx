...
const Footer = () => {
  ...
  return (
    <div className=' flex flex-col justify-center items-center h-screen w-full bg-yellow-400 snap-start bg-footerImg bg-center bg-no-repeat bg-cover'>
      <div className=' md:w-[70%] h-full md:flex justify-between items-center text-white mt-5 md:mt-28'>
        <div className=' flex flex-col gap-5 md:gap-10'>
          ...
          <form className='flex flex-col gap-4 m-auto w-80 md:w-auto md:m-0 mt-10 md:mt-0'>
            <label className=' text-gray-200' for='first_name'>FIRST NAME</label>
            ...
            <label className=' text-gray-200' for='last_name'>LAST NAME</label>
            ...
            <label className=' text-gray-200' for='email'>EMAIL</label>
            ...
            <label className=' text-gray-200' for='mobile_no'>PHONE NUMBER</label>
            ...
            <label className=' text-gray-200' for='message'>MESSAGE</label>
            ...
            <label for='submit' className='flex gap-3 bg-transparent cursor-pointer border-white border-[1px] mt-5 shadow-md shadow-violet-500 py-2 px-5 w-max rounded-full'>
