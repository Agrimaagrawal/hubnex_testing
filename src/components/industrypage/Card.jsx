  ...
  return (
    ...
    < div className='bg-black flex flex-col items-center  min-h-full'>
      <div className="rounded-br-full rounded-bl-full  h-[400px] w-full absolute bg-gradient-to-b from-blue-800 to-black blur-sm "></div>
        ...
        <div className='text-white font-gilroy-bold text-[2rem] md:text-[3rem] text-center pt-20 max-w-[600px] backdrop-blur-sm font-bold'>
          <h1 className='text-twhite '>What We Do</h1>
        </div>
      
        <div className='text-white font-gilroy-light md:text-[1.3rem] text-md text-center p-5 max-w-[1090px] mt-2 backdrop-blur-sm '>
